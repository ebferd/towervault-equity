...
CREATE TABLE `investment_holdings` (
  ...
  `payment_method`   ENUM('crypto','paypal','wire','zelle','cashapp','wallet') NOT NULL,
...
CREATE TABLE `deposit_invoices` (
  ...
  `amount`         DECIMAL(15,2) NOT NULL,
  `method`         ENUM('crypto','paypal','wire','zelle','cashapp') NOT NULL,
...
-- ── Marketing / cold-outreach campaigns (migration_v11) ──────
...
-- ── Marketing open-tracking (migration_v16) ──────────────────
